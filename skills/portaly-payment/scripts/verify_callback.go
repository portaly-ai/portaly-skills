...
var (
	...
	supportedKeyOrder = []string{
		...
		"campaign", "cancelAtPeriodEnd", "canceledAt", "cancelEffectiveAt", "cancelReason",
		"cancelReasonNote", "cancelRequestedAt", "cancelRequestedBy", "carrierNumber",
		"carrierType", "cart_id", "chargedAt", "checkoutSessionId", "child", "code", "codeId",
		"company", "companyId", "completedAt", "currency", "currentPeriodStartedAt",
		"customerEmail", "customerName", "customerPhone", "cycles", "discount",
		"discountedAmount", "duration", "empty", "enabled", "error", "event", "failedAt",
		"failureCount", "failureReason", "finalAmount", "flags", "invoice", "lastChargedAt",
		"lastFailureAt", "lastFailureReason", "lastPaymentReference", "list",
		"merchantConsumerId", "merchantOrderNumber", "metadata", "mode", "negative", "nested",
		"nextBillingAt", "nextRetryAt", "orderId", "orderMerchantOrderNumber", "orders",
		"orderSuccessPageUrl", "originalAmount", "paidAmount", "paymentId", "paymentMethod",
		"paymentMethodId", "paymentProvider", "paymentReference", "planId", "planIds",
		"planName", "productId", "productName", "profileId", "recTradeId", "recurringReady",
		...
		"source", "status", "subscriptionCanceledByRefund", "subscriptionId", "tappayPayment",
		"totalAmount", "tracking", "tradeId", "type", "value", "verificationCharge",
